...
def main():
    ...
    for contig_id in contigs_ids:
        ...
        annotate_mito = "mitofinder --max-contig-size {} -j {}.annotation -a {}.mitogenome.fa -r {} -o {}".format(max_contig_size, contig_id, contig_id, args.g, args.o)
        ...
        if strand == -1:
            ...
            new_gb = rotation.annotate(os.path.dirname(genome), os.path.abspath(genome_rc), os.path.abspath(args.g), contig_id, args.o, max_contig_size)
