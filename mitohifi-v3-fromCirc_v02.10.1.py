...
def main():
    ...
    if os.path.isfile(mitogenome_gb_rc):
        repr_contig_gb_final = repr_contig_gb 
    else:
        repr_contig_gb_final = repr_contig_gb
    
    print("repr_contig_gb_final: ", repr_contig_gb_final) # for debugging, delete later
    # create a copy of the representative contig called "final_mitogenome.gb"
