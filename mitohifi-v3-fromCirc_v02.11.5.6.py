...
def main():
    ...
    if args.r:
        ...
        print("minimap command: ", minimap_cmd) # for debugging
    ...
    for contig_id in contigs_ids:
        ...
        subprocess.run(["mitofinder", "--max-contig-size", max_contig_size, "-j", contig_id+".annotation", "-a", contig_id+".mitogenome.fa", "-r", args.g, "-o", args.o, "-p", args.t], stderr=subprocess.STDOUT)
