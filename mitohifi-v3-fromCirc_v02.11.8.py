...
def main():
    ...
    for contig_id in contigs_ids:
        ...
        subprocess.run(["mitofinder", "--new-genes", "--max-contig-size", str(max_contig_size), "-j", contig_id+".annotation", "-a", contig_id+".mitogenome.fa", "-r", args.g, "-o", args.o, "-p", str(args.t)], stderr=subprocess.STDOUT)
        ...
        contig_shifts[contig_id] = [frameshifts, mitogenome_location, gb_len, num_genes]
